...
public class Admin extends Person {
	...
	public boolean addManager(Manager newManager) {
		...
		return managerInsert.insert(acc);
	...
	public int updateManager(Manager managerData)
	{
		UpdationHandler updateManager=new UpdationHandler();
		return updateManager.update(managerData);
	}
	...
	public boolean addFranchise(Franchise newfranchise, ArrayList<String> ids ) {
		...
		return insertFranchise.insert(newfranchise, ids);
	}
