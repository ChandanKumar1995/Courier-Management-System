...
public class Employee extends Person {
	...
	public boolean addCourier(RegisteredCourier newCourier) {
		InsertionHandler insertCourier=new InsertionHandler();
		return insertCourier.insert(newCourier);
	}
	
	public boolean addCourier(UnRegisteredCourier newCourier    ) {
		// TODO Auto-generated method stub
		InsertionHandler insertCourier=new InsertionHandler();
		return insertCourier.insert(newCourier);
	}
	
	public int updateCourier(RegisteredCourier newCourier) {
		UpdationHandler updateCourier=new UpdationHandler();
		return updateCourier.update(newCourier);
	}
	
	public int updateCourier(UnRegisteredCourier newCourier) {
		UpdationHandler updateCourier=new UpdationHandler();
		return updateCourier.update(newCourier);
	}	
	
	public int CancelCourier(CourierModel temp) {
		UpdationHandler update = new UpdationHandler();
		return update.cancelCourier(temp.CID.get());
	}
