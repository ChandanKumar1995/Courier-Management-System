...
public class Manager extends Person {
	...
	public boolean addEmployee(Employee newEmployee)
	{
		...
		return handler.insert(acc);
	}
	
	public int updateEmployee(Employee EmployeeData)
	{
		Franchise f=new Franchise();
		return f.updateEmployee(EmployeeData);
	}
	...
	public boolean fireEmployee(String id) {
		 ...
		 System.out.println("updateManager.fireEmployee(id) "+updateManager.fireEmployee(id));
	...
	public int updateCutomer(Customer customer) {
		UpdationHandler handler = new UpdationHandler();
		return handler.update(customer);
	}
	...
	public int deleteCustomer(CustomerModel customer) {
		...
		return handler.update(cus, false);
	}
